...
public class FrmVista extends javax.swing.JFrame implements Observer {
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        ...
        //Como hay un joinable usamos isAlive para ver si el hilo sigue en ejecucion
        for (Thread hilo : hilos) {
            if (hilo.isAlive()) {
                try {
                    //Lo usamos para esperar a que el hilo termine su ejecución
                    hilo.join();
